...
namespace BrawlInstaller.Services
{
    ...
    internal class PackageService : IPackageService
    {
        ...
        public FighterPackage ExtractFighter(FighterIds fighterIds)
        {
            ...
            fighterPackage.CosmeticList.Cosmetics = cosmetics;
        ...
        public void SaveFighter(FighterPackage fighterPackage)
        {
            ...
            foreach(var definition in _settingsService.BuildSettings.CosmeticSettings.Where(x => fighterPackage.CosmeticList.ChangedCosmetics
            .Any(y => y.cosmeticType == x.CosmeticType && y.style == x.Style)))
            {
                var cosmetics = fighterPackage.CosmeticList.Cosmetics.Where(x => x.CosmeticType == definition.CosmeticType && x.Style == definition.Style).ToList();
